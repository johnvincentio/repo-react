...
import { goalsType, selectType, commandType } from '../../types';
...
class EditorGoals extends React.Component {
	...
	render() {
		...
		// console.log('selectedType ', selectedType, ' selectedGoalId ', selectedGoalId);

		const { commandedType } = this.props.command;
		// console.log('commandedType ', commandedType);
		const addGoal = (selectedType === '' && commandedType === 'add');
		// console.log('addGoal ', addGoal);
		return (
			<div>
				<div>
					<OpenMenu />
