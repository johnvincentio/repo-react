...
class EditTask extends React.Component {
	...
	updateTaskTitle(value) {
		...
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'title', value });
	}

	updateTaskStatus(value) {
		// console.log('--- updateTaskStatus, value:', value);
		const { goalId, projectId, task } = this.props;
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'status', value: value * 1 });
	}
	...
	updateTaskStartDate(value) {
		...
		this.props.actions.updateUserDateTask(goalId, projectId, task.id, { field: 'start', value });
	}
	...
	updateTaskEndDate(value) {
		...
		this.props.actions.updateUserDateTask(goalId, projectId, task.id, { field: 'end', value });
	}

	updateTaskRepeat(value) {
		// console.log('--- updateTaskRepeat, value:', value, ' props ', this.props);
		const { goalId, projectId, task } = this.props;
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'repeat', value: value * 1 });
	}
	...
	updateTaskEstimate(value) {
		...
		const { goalId, projectId, task } = this.props;
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'estimate', value });
	}
	...
	updateTaskActual(value) {
		...
		const { goalId, projectId, task } = this.props;
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'actual', value });
	}
	...
	updateTaskDescription(value) {
		...
		const { goalId, projectId, task } = this.props;
		this.props.actions.updateUserTask(goalId, projectId, task.id, { field: 'description', value });
	}
	...
	render() {
		...
		return (
			<div>
				<button className="task--task-cancel" onClick={() => this.onClickCancel()}>
