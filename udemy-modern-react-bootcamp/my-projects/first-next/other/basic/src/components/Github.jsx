...
class Github extends React.Component {
	...
	onSearchSubmit = async search => {
		// console.log('Github::onSearchSubmit; search ', search);
	...
	render() {
		// console.log('Github::render(); this.state ', this.state, ' this.props ', this.props);
		const { user, isLoading, error } = this.state;

		// console.log('Github::render(); user ', user);
